using Nethereum.Aspire.Explorer;
...
builder.Services.AddHttpClient<ILoadTestMetricsService, LoadTestMetricsService>(client =>
{
    client.BaseAddress = new Uri("https+http://loadgenerator");
});

if (builder.Configuration.GetValue("Explorer:Seeding:Enabled", true))
{
...
app.MapRazorComponents<Nethereum.Explorer.Components.App>()
    ...
    .AddAdditionalAssemblies(
        ...
        typeof(Nethereum.Aspire.Explorer.Services.LoadTestMetricsService).Assembly);
