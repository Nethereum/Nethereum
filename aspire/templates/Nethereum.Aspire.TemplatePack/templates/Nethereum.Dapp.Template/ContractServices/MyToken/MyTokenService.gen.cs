...
namespace NethereumDapp.ContractServices.MyToken
{
    public partial class MyTokenService: MyTokenServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, MyTokenDeployment myTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<MyTokenDeployment>().SendRequestAndWaitForReceiptAsync(myTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, MyTokenDeployment myTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<MyTokenDeployment>().SendRequestAsync(myTokenDeployment);
        }

        public static async Task<MyTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, MyTokenDeployment myTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, myTokenDeployment, cancellationTokenSource);
            return new MyTokenService(web3, receipt.ContractAddress);
        }

        public MyTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class MyTokenServiceBase: ContractWeb3ServiceBase
    {

        public MyTokenServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
