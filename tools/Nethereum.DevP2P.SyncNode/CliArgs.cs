...
namespace Nethereum.DevP2P.SyncNode
{
    ...
    internal sealed class CliArgs
    {
        ...
        //   N > 0 : bind that port (geth default 30303). Listener accepts inbound peers
        ...
        // Serve-empty toggle (geth's default behaviour). When true the inbound
        ...
        public static void PrintUsage()
        {
            ...
            Console.WriteLine("  --listen-port N           Bind RlpxListener for inbound peers. Default 30303 (geth default).");
