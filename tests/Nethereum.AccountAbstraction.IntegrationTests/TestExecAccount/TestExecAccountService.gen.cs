...
{
    public partial class TestExecAccountService: TestExecAccountServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, TestExecAccountDeployment testExecAccountDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TestExecAccountDeployment>().SendRequestAndWaitForReceiptAsync(testExecAccountDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, TestExecAccountDeployment testExecAccountDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TestExecAccountDeployment>().SendRequestAsync(testExecAccountDeployment);
        }

        public static async Task<TestExecAccountService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, TestExecAccountDeployment testExecAccountDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, testExecAccountDeployment, cancellationTokenSource);
            return new TestExecAccountService(web3, receipt.ContractAddress);
        }

        public TestExecAccountService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class TestExecAccountServiceBase: ContractWeb3ServiceBase
    {

        public TestExecAccountServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
