...
namespace Nethereum.Rsk.IntegrationTests
{
    public class GetBlockIntegrationTests
    {
        ...
        public async Task ShouldGetBlockWithHashesByNumber()
        {
            ...
            var block = await web3.RskEth.GetBlockWithTransactionsHashesByNumber.SendRequestAsync(new HexBigInteger("0x143828"));
        ...
        {
            var web3 = new Web3Rsk(rskUrl);
            var block = await web3.RskEth.GetBlockWithTransactionsHashesByHash.SendRequestAsync("0x6cd513001e2d9c79847c797712407b9215e0fc74a4f0b368a42b3bc1a831bb57");
            Assert.Equal(59240000, block.GetMinimumGasPriceAsBigInteger());
        }
