    ...
    public class UsingNewKeywordOnProperties
    {
        ...
        public class DecodeTestDeploymentBase : ContractDeploymentMessage
        {
            public static string BYTECODE =
                "";
        ...
        {
            [Parameter("uint256", "_id", 1)] public virtual BigInteger Id { get; set; }
        }
        ...
        {
            [Parameter("tuple", "_vehicle", 1)] public virtual Vehicle Vehicle { get; set; }
        }
        ...
        {
            [Parameter("uint256", "id", 1)] public virtual BigInteger Id { get; set; }

            [Parameter("bytes32", "manufacturer", 2)]
            public virtual byte[] Manufacturer { get; set; }

            [Parameter("bytes32", "model", 3)] public virtual byte[] Model { get; set; }
        ...
        {
            [Parameter("tuple", "_vehicle", 1)] public virtual Vehicle_WithSomeNewPropertyTypes Vehicle { get; set; }
        }
        ...
        public partial class Vehicle_WithSomeNewPropertyTypes : Vehicle
        {
            ...
            [Parameter("bytes32", "model", 3)] public new string Model { get; set; }
        }
        ...
        {
            [Parameter("tuple", "_vehicle", 1)] public virtual Vehicle_WithAllNewPropertyTypes Vehicle { get; set; }
        }

        public partial class Vehicle_WithAllNewPropertyTypes : Vehicle
        {
            [Parameter("uint256", "id", 1)] public new BigInteger Id { get; set; }
