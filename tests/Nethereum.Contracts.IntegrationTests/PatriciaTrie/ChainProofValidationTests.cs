...
namespace Nethereum.Contracts.IntegrationTests.Patricia
{
    ...
    public class ChainProofValidationTests
    {
        ...
        public async void ShouldValidateBalanceOfEOA()
        {
            ...
            var accountProof = await web3.Eth.ChainProofValidation.GetAndValidateAccountProof("0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae", null, null);
        ...
        public async void ShouldValidateStorage()
        {
            ...
            var value = await web3.Eth.ChainProofValidation.GetAndValidateValueFromStorage("0x5E4e65926BA27467555EB562121fac00D24E9dD2", "0x0", null, BlockParameter.CreateLatest());
