...
{
    public static class GethTrieTestVectors
    {
        public class TrieTestCase
        {
            public string Name { get; set; }
            public List<(string Key, string Value)> Operations { get; set; }
            public string ExpectedRoot { get; set; }
        }

        public static IEnumerable<object[]> GetTestCases()
        {
            yield return new object[] { GetEmptyValuesTest() };
            yield return new object[] { GetBranchingTest() };
            yield return new object[] { GetJeffTest() };
            yield return new object[] { GetInsertMiddleLeafTest() };
            yield return new object[] { GetBranchValueUpdateTest() };
        }

        public static TrieTestCase GetEmptyValuesTest()
        {
            return new TrieTestCase
            {
                Name = "emptyValues",
        ...
        public static TrieTestCase GetBranchingTest()
        {
            return new TrieTestCase
            {
                Name = "branchingTests",
        ...
        public static TrieTestCase GetJeffTest()
        {
            return new TrieTestCase
            {
                Name = "jeff",
                Operations = new List<(string, string)>
                {
                    ...
                    ("0x0000000000000000000000000000000000000000000000001234567890", "0x697c7b8c961b56f675d570498424ac8de1a918f6"),
                    ...
                    ("0x0000000000000000000000000000000000000000000000001234567890", null),
                ...
                ExpectedRoot = "9f6221ebb8efe7cff60a716ecb886e67dd042014be444669f0159d8e68b42100"
            };
        }

        public static TrieTestCase GetInsertMiddleLeafTest()
        {
            return new TrieTestCase
            {
                ...
                ExpectedRoot = "cb65032e2f76c48b82b5c24b3db8f670ce73982869d38cd39a624f23d62a9e89"
            };
        }

        public static TrieTestCase GetBranchValueUpdateTest()
        {
            return new TrieTestCase
            {
                ...
                ExpectedRoot = "7a320748f780ad9ad5b0837302075ce0eeba6c26e3d8562c67ccc0f1b273298a"
            };
        }
    }
}
