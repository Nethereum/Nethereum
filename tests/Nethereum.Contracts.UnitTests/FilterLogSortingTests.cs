...
namespace Nethereum.Contracts.UnitTests
{
    public class FilterLogSortingTests
    {
        ...
        public void ShouldSortBasedOnBlockNumber()
        {
            ...
            var filterLog2 =
                new FilterLog {BlockNumber = new HexBigInteger(2), TransactionIndex = new HexBigInteger(1)};
            var filterLog3 =
                new FilterLog {BlockNumber = new HexBigInteger(3), TransactionIndex = new HexBigInteger(1)};
        ...
        public void ShouldSortBasedOnBlockNumberAndTransactionIndex()
        {
            ...
            var filterLog2 =
                new FilterLog {BlockNumber = new HexBigInteger(2), TransactionIndex = new HexBigInteger(1)};
            var filterLog3 =
                new FilterLog {BlockNumber = new HexBigInteger(2), TransactionIndex = new HexBigInteger(2)};
