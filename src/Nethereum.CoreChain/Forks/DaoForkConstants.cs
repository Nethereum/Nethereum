...
{
    /// <summary>
    /// Mainnet DAO fork (block 1,920,000) constants — the canonical DAO drain
    /// list applied by the DAO hard-fork state transition.
    ///
    /// 115 entries: 57 child-DAO accounts × 2 (each with a paired
    /// "extra-balance" account) + the main DAO + the main DAO's
    /// extra-balance account. The list has the DAO contract
    ...
    public static class DaoForkConstants
    {
        ...
        /// 1,920,000 — the account is created on first credit (our CreditAsync
        /// does the same).
        /// </summary>
        public const string WithdrawContractAddress = "0xbf4ed7b27f1d666546e30d74d50d173d20bca754";

        /// <summary>
        /// All 115 source accounts, in canonical drain order. Includes child-DAO
