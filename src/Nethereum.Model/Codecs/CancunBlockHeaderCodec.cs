    ...
    public sealed class CancunBlockHeaderCodec : IBlockHeaderCodec
    {
        ...
        public byte[] Encode(BlockHeader header)
        {
            ...
            var fields = new byte[][]
            {
                ...
                // BlobGasUsed/ExcessBlobGas: 0 is a valid wire value (encodes
                // as 0x80, same as null would). Null → 0 substitution is
                // safe here; a Cancun block with zero blob gas is canonical.
