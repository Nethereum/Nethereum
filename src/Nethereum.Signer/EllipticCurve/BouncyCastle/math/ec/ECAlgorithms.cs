...
namespace NBitcoin.BouncyCastle.Math.EC
{
	public class ECAlgorithms
	{
        ...
        */
		...
		public static ECPoint ImplShamirsTrickJsf(ECPoint P, BigInteger k, ECPoint Q, BigInteger l)
		{
		...
		public static ECPoint ImplShamirsTrickWNaf(ECPoint P, BigInteger k, ECPointMap pointMapQ, BigInteger l)
		{
			bool negK = k.SignValue < 0, negL = l.SignValue < 0;
		...
		public static ECPoint ImplSumOfMultiplies(ECPoint[] ps, BigInteger[] ks)
		{
			int count = ps.Length;
		...
		public static ECPoint ImplSumOfMultiplies(ECPoint[] ps, ECPointMap pointMap, BigInteger[] ks)
		{
