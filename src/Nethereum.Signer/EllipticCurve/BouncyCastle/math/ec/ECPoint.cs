...
namespace NBitcoin.BouncyCastle.Math.EC
{
	...
	internal abstract class ECPoint
	{
		...
		public readonly ECCurve m_curve;
		public readonly ECFieldElement m_x, m_y;
		public readonly ECFieldElement[] m_zs;
		public readonly bool m_withCompression;

		// Dictionary is (string -> PreCompInfo)
		public IDictionary m_preCompTable = null;
		...
		public ECPoint(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression)
		{
			this.m_curve = curve;
			this.m_x = x;
			this.m_y = y;
		...
		public ECFieldElement RawXCoord
		{
			get
			{
				return m_x;
		...
		public ECFieldElement RawYCoord
		{
			get
			{
				return m_y;
		...
		public ECFieldElement[] RawZCoords
		{
			get
			{
				return m_zs;
		...
		public abstract bool CompressionYTilde
		{
			get;
		}
		...
		: ECPoint
	{
		...
		public ECPointBase(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression)
		...
		: ECPointBase
	{
		...
		public override bool CompressionYTilde
		{
			get
			{
		...
		: AbstractFpPoint
	{
		...
		public FpPoint(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression)
			: base(curve, x, y, zs, withCompression)
		{
		}
		...
		: AbstractF2mPoint
	{
		...
		public F2mPoint(ECCurve curve, ECFieldElement x, ECFieldElement y, ECFieldElement[] zs, bool withCompression)
			: base(curve, x, y, zs, withCompression)
		{
		}
