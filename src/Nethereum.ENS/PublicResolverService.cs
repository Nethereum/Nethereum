...
namespace Nethereum.ENS
{
    public partial class PublicResolverService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3.Web3 web3,
            PublicResolverDeployment publicResolverDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PublicResolverDeployment>()
                .SendRequestAndWaitForReceiptAsync(publicResolverDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Web3.Web3 web3,
            PublicResolverDeployment publicResolverDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PublicResolverDeployment>()
                .SendRequestAsync(publicResolverDeployment);
        }

        public static async Task<PublicResolverService> DeployContractAndGetServiceAsync(Web3.Web3 web3,
            PublicResolverDeployment publicResolverDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt =
                await DeployContractAndWaitForReceiptAsync(web3, publicResolverDeployment, cancellationTokenSource);
        ...
        public Task<TransactionReceipt> SetPubkeyRequestAndWaitForReceiptAsync(SetPubkeyFunction setPubkeyFunction,
            CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetPubkeyRequestAndWaitForReceiptAsync(byte[] node, byte[] x, byte[] y,
            CancellationTokenSource cancellationToken = null)
        {
            var setPubkeyFunction = new SetPubkeyFunction();
            setPubkeyFunction.Node = node;
        ...
        public Task<TransactionReceipt> SetMultihashRequestAndWaitForReceiptAsync(
            SetMultihashFunction setMultihashFunction, CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetMultihashRequestAndWaitForReceiptAsync(byte[] node, byte[] hash,
            CancellationTokenSource cancellationToken = null)
        {
            var setMultihashFunction = new SetMultihashFunction();
            setMultihashFunction.Node = node;
        ...
        public Task<TransactionReceipt> SetContentRequestAndWaitForReceiptAsync(SetContentFunction setContentFunction,
            CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetContentRequestAndWaitForReceiptAsync(byte[] node, byte[] hash,
            CancellationTokenSource cancellationToken = null)
        {
            var setContentFunction = new SetContentFunction();
            setContentFunction.Node = node;
        ...
        public Task<PubkeyOutputDTO> PubkeyQueryAsync(PubkeyFunction pubkeyFunction,
            BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryDeserializingToObjectAsync<PubkeyFunction, PubkeyOutputDTO>(pubkeyFunction,
                blockParameter);
        }
        ...
        public Task<byte[]> MultihashQueryAsync(MultihashFunction multihashFunction,
            BlockParameter blockParameter = null)
        {
