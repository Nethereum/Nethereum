...
namespace Nethereum.HdWallet.Tests
{
    public class TokenTransferTest
    {
        ...
        {
            var wallet = new Wallet(WalletTests.Words, WalletTests.Password);
            ...
            var standarErc20Service = new StandardTokenEIP20.StandardTokenService(web3, receipt.ContractAddress);
