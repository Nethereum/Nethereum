...
namespace Nethereum.Web3
{
    public class Function : FunctionBase
    {
        ...
        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>(params object[] functionInput) where TReturn: new()
        {
            var encodedInput = GetData(functionInput);
        ...
        {
            var encodedInput = GetData(functionInput);
            return base.CallAsync<TReturn>(new TReturn(), encodedInput, from, gas, value);
        }
        ...
        {
            var encodedInput = GetData(functionInput);
            return base.CallAsync<TReturn>(new TReturn(), encodedInput, callInput);
        }
        ...
        {
            var encodedInput = GetData(functionInput);
            return base.CallAsync<TReturn>(new TReturn(), encodedInput, callInput, blockParameter);
        }
    ...
    public class Function<TFunctionInput> : FunctionBase
    {
        ...
        public Task<TReturn> CallDeserializingToObjectAsync<TReturn>(TFunctionInput functionInput, string from, HexBigInteger gas,
