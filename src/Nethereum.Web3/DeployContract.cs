...
namespace Nethereum.Web3
{
    public class DeployContract
    {
            ...
            params object[] values)
        {
            ...
            return await ethSendTransaction.SendRequestAsync(new EthSendTransactionInput(encodedData, gas, from));
        }
            ...
            params object[] values)
        {
            ...
            return await ethSendTransaction.SendRequestAsync(new EthSendTransactionInput(encodedData, null, from));
        }
        ...
        public async Task<string> SendRequestAsync(string contractByteCode, string from, HexBigInteger gas)
        {
            ...
            return await ethSendTransaction.SendRequestAsync(new EthSendTransactionInput(contractByteCode, gas, from));
        }

        public async Task<string> SendRequestAsync(string contractByteCode, string from)
        {
            return await ethSendTransaction.SendRequestAsync(new EthSendTransactionInput(contractByteCode, null, from));
        }
