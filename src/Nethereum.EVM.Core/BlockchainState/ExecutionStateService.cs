...
namespace Nethereum.EVM.BlockchainState
{
    public class ExecutionStateService
    {
        ...
        // Tx-wide self-destructed set (HasSelfDestructed semantics).
        ...
        /// <summary>
        /// EIP-161 touch semantics: at EIP-158+ forks the touch flag is
        ...
        /// tracked. Matches the canonical read-only code resolution used by
        /// CALLCODE, DELEGATECALL and STATICCALL — those instructions read
        /// the target's bytecode without ever creating the account,
