...
namespace Nethereum.EVM.Execution.TxFinalisation
{
    ...
    ///
    /// <para>Branches on Byzantium: pre-Byzantium computes the intermediate
    /// state root and stamps it on the receipt; post-Byzantium leaves it null
    /// and emits the status byte instead.</para>
    /// </summary>
