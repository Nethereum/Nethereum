...
namespace Nethereum.EVM
{
    public partial class TransactionExecutor
    {
...
#endif
        {
            ...
            // costs 2600 (cold) not 100 (warm). Geth core/vm/eips.go enable3651.
...
#endif
        {
            ...
            // EIP-158+ forks (cleanEmptyAccounts=true) get geth-style permanent
...
#endif
        {
            ...
            {
                // Mirror geth core/vm/evm.go Call's unconditional Transfer:
                ...
                // where geth's cleanup deletes them. For pre-EIP-158 the touch
