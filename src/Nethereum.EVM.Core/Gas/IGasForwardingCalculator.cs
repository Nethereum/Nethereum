namespace Nethereum.EVM.Gas
{
    public interface IGasForwardingCalculator
    {
        ...
        /// amount is NOT under user control (CREATE/CREATE2 — the parent's
        /// remaining gas is forwarded directly).
        /// </summary>
        ...
        /// stack. Implements the canonical CALL gas-forwarding rule:
        /// <para>
