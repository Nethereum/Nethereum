namespace Nethereum.EVM.Gas
{
    public static class GasConstants
    {
        ...
        public const int SSTORE_RESET_PRE_BERLIN = 5000;  // Pre-EIP-2929 flat reset cost
        ...
        // EIP-7951: P256VERIFY precompile (Osaka)
        public const int P256VERIFY_GAS = 6900;            // 0x0100
    }
}
