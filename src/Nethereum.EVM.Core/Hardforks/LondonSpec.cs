...
namespace Nethereum.EVM.Hardforks
{
    ...
    ///   <item>Geth: <c>params/config.go LondonBlock</c>,
    ///   <c>core/vm/jump_table.go newLondonInstructionSet</c>,
    ///   <c>core/vm/gas_table.go gasSStoreEIP3529</c>,
    ///   <c>params/protocol_params.go RefundQuotientEIP3529</c>.</item>
    /// </list>
    ///
