namespace Nethereum.EVM.Hardforks.Policies
{
    ...
    ///
    /// <para><b>Geth ref:</b> <c>core/vm/eips.go enable3651</c>: adds
    /// <c>vmenv.Origin</c> AND <c>vmenv.Context.Coinbase</c> to the
    /// pre-warm list at <c>core/state_processor.go</c>.</para>
    /// </summary>
