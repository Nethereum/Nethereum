namespace Nethereum.EVM.Hardforks.Policies
{
    ...
    /// </list>
    ///
    /// <para><b>Geth ref:</b> <c>core/state_transition.go applyTransition</c>
    /// — <c>amount := new(big.Int).Mul(new(big.Int).SetUint64(st.gasUsed()), effectiveTip)</c>
    /// vs the pre-EIP-1559 <c>gasUsed * gasPrice</c> path.</para>
    /// </summary>
