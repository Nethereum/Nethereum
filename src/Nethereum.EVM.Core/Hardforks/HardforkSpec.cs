...
namespace Nethereum.EVM.Hardforks
{
    ...
    public sealed record HardforkSpec
    {
        ...
        /// (the EIP-161 finalise-with-delete-empty-objects behaviour).
        ///
        ...
        ///   empty deployed code. A Yellow-Paper omission reproduced for
        ///   client compatibility.</item>
        ...
        /// The create path calls <c>CreateAccount(addr)</c> unconditionally;
        /// the only per-fork variation is the initial nonce, already encoded by
