...
namespace Nethereum.EVM.Hardforks
{
    ...
    ///   <item>Geth: <c>params/config.go EIP150Block</c>,
    ///   <c>core/vm/jump_table.go newTangerineWhistleInstructionSet</c>,
    ///   <c>core/vm/gas.go callGas</c> (63/64 implementation).</item>
    /// </list>
    /// </summary>
