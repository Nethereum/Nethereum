...
namespace Nethereum.EVM.Hardforks
{
    ...
    ///   <item>Geth: <c>params/config.go HomesteadBlock</c>,
    ///   <c>core/vm/jump_table.go newHomesteadInstructionSet</c>,
    ///   <c>core/vm/evm.go create</c> (ErrCodeStoreOutOfGas hard fail).</item>
    /// </list>
    /// </summary>
