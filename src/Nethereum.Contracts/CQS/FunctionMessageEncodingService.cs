...
namespace Nethereum.Contracts.CQS
{
    public class FunctionMessageEncodingService<TContractFunction> :
        ...
        IFunctionMessageEncodingService<TContractFunction> where TContractFunction : ContractMessage
    {
        ...
        private void EnsureContractAddressIsSet()
        {
