...
namespace Nethereum.Contracts
{
    ...
    {
        public static bool IsLogForEvent<TEventDTO>(JToken log)
        {
        ...
        {
            return IsLogForEvent(eventABI.Sha33Signature, log);
        }

        public static bool IsLogForEvent(string signature, FilterLog log)
        {
