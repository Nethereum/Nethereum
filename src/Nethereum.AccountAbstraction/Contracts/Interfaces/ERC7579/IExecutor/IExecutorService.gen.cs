...
namespace Nethereum.AccountAbstraction.Contracts.Interfaces.ERC7579.IExecutor
{
    public partial class IExecutorService: IExecutorServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, IExecutorDeployment iExecutorDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IExecutorDeployment>().SendRequestAndWaitForReceiptAsync(iExecutorDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, IExecutorDeployment iExecutorDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IExecutorDeployment>().SendRequestAsync(iExecutorDeployment);
        }

        public static async Task<IExecutorService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, IExecutorDeployment iExecutorDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iExecutorDeployment, cancellationTokenSource);
            return new IExecutorService(web3, receipt.ContractAddress);
        }

        public IExecutorService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class IExecutorServiceBase: ContractWeb3ServiceBase
    {

        public IExecutorServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
