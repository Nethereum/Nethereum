...
namespace Nethereum.AccountAbstraction.Contracts.Interfaces.ERC7579.IModule.ContractDefinition
{


    public partial class IModuleDeployment : IModuleDeploymentBase
    {
        public IModuleDeployment() : base(BYTECODE) { }
        public IModuleDeployment(string byteCode) : base(byteCode) { }
    }

    public class IModuleDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "0x";
        public IModuleDeploymentBase() : base(BYTECODE) { }
        public IModuleDeploymentBase(string byteCode) : base(byteCode) { }
