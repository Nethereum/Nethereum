    ...
    public class ViewOnlyAccountEditorLocalizer : ComponentLocalizerBase<ViewOnlyAccountCreationViewModel>
    {
        ...
        protected override void RegisterTranslations()
        {
            _globalService.RegisterTranslations(_componentName, "en-US", new Dictionary<string, string>
            {
                ...
                ["AccountNameHelperText"] = "Give your account a memorable name (optional)",
                ["AccountNamePlaceholder"] = "Watch Account",
                ["AddressLabel"] = "Ethereum Address",
                ["AddressHelperText"] = "Enter the Ethereum address you want to watch",
                ["AddressPlaceholder"] = "0x...",
                ["ValidAddressText"] = "Valid Address",
                ["InvalidAddressText"] = "Invalid Address",
                ["InfoTitle"] = "View-Only Account",
                ["InfoDescription"] = "This account can only view balances and transactions. You cannot send transactions or sign messages.",
                ["WhatCanDoTitle"] = "What you can do:",
                ["ViewBalanceText"] = "• View token balances",
                ["ViewTransactionsText"] = "• View transaction history", 
                ["ViewNFTsText"] = "• View NFTs and collectibles",
                ["WhatCannotDoTitle"] = "What you cannot do:",
                ["CannotSendText"] = "• Send transactions",
                ["CannotSignText"] = "• Sign messages",
                ["CannotInteractText"] = "• Interact with smart contracts",
                ["BackToLoginText"] = "Back to Login",
                ["BackToAccountSelectionText"] = "Back to Account Selection",
                ["AddAccountText"] = "Add Account",
                ["ValidAddressMessage"] = "Valid Ethereum address",
                ["InvalidAddressMessage"] = "Invalid Ethereum address format",
            ...
            _globalService.RegisterTranslations(_componentName, "es-ES", new Dictionary<string, string>
            {
                ...
                ["AccountNameHelperText"] = "Dale un nombre memorable a tu cuenta (opcional)",
                ["AccountNamePlaceholder"] = "Cuenta de Observación",
                ["AddressLabel"] = "Dirección Ethereum",
                ["AddressHelperText"] = "Ingresa la dirección Ethereum que quieres observar",
                ["AddressPlaceholder"] = "0x...",
                ["ValidAddressText"] = "Dirección Válida",
                ["InvalidAddressText"] = "Dirección Inválida",
                ["InfoTitle"] = "Cuenta de Solo Lectura",
                ["InfoDescription"] = "Esta cuenta solo puede ver saldos y transacciones. No puedes enviar transacciones o firmar mensajes.",
                ["WhatCanDoTitle"] = "Lo que puedes hacer:",
                ["ViewBalanceText"] = "• Ver saldos de tokens",
                ["ViewTransactionsText"] = "• Ver historial de transacciones",
                ["ViewNFTsText"] = "• Ver NFTs y coleccionables",
                ["WhatCannotDoTitle"] = "Lo que no puedes hacer:",
                ["CannotSendText"] = "• Enviar transacciones",
                ["CannotSignText"] = "• Firmar mensajes",
                ["CannotInteractText"] = "• Interactuar con contratos inteligentes",
                ["BackToLoginText"] = "Volver al Inicio de Sesión",
                ["BackToAccountSelectionText"] = "Volver a Selección de Cuenta",
                ["AddAccountText"] = "Añadir Cuenta",
                ["ValidAddressMessage"] = "Dirección Ethereum válida",
                ["InvalidAddressMessage"] = "Formato de dirección Ethereum inválido",
