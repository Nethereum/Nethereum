...
namespace Nethereum.Uport
{
   public class UportRegistryService
   {
        ...
        public static string BYTE_CODE = "";

        public static Task<string> DeployContractAsync(Web3.Web3 web3, string addressFrom, string previousPublishedVersion, HexBigInteger gas = null, HexBigInteger valueAmount = null) 
        {
            return web3.Eth.DeployContract.SendRequestAsync(ABI, BYTE_CODE, addressFrom, gas, valueAmount , previousPublishedVersion);
        }

        public static async Task<UportRegistryService> DeployContractAndGetServiceAsync(ITransactionReceiptService transactionReceiptService, Web3.Web3 web3, 
        ...
        public Task<Int32> VersionAsyncCall() {
            ...
            return function.CallAsync<Int32>();
        }
