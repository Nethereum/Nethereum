...
namespace Nethereum.Mud.TableRepository
{
    ...
    public class StoreRecordRestMudIndexerApiClient: ITablePredicateQueryRepository
    {
        ...
        public StoreRecordRestMudIndexerApiClient(IRestHttpHelper httpHelper, string baseUrl, string postPath = "storedrecords")
        {
