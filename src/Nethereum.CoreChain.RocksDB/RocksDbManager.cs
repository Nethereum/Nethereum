...
namespace Nethereum.CoreChain.RocksDB
{
    public class RocksDbManager : IDisposable
    {
        ...
        // EIP-4895 block withdrawals persisted alongside uncles so a forward
        // execute or re-stream of a post-Shanghai block recovers the body
        // exactly as it was on the wire. Value layout: RLP list of
        // WithdrawalEncoder encodings, key = block hash.
