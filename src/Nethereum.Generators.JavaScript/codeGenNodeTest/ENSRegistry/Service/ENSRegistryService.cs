...
namespace Nethereum.ENS.ENSRegistry.Service
{

    public class ENSRegistryService
    {
    
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, ENSRegistryDeployment eNSRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Web3 web3, ENSRegistryDeployment eNSRegistryDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ENSRegistryDeployment>().SendRequestAsync(eNSRegistryDeployment);
        }
        public static async Task<ENSRegistryService> DeployContractAndGetServiceAsync(Web3 web3, ENSRegistryDeployment eNSRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public ENSRegistryService(Web3 web3, string contractAddress)
        {
            Web3 = web3;
