...
using Nethereum.Contracts.CQSNethereum.Contracts;
using System.Threading;
namespace StandardToken.MyContractName.ContractDefinition
{
    
    
    public partial class MyContractNameDeployment:MyContractNameDeploymentBase
    {
    ...
    public class MyContractNameDeploymentBase:ContractDeploymentMessage
    {
        ...
        public MyContractNameDeploymentBase():base(BYTECODE) { }
        
        public MyContractNameDeploymentBase(string byteCode):base(byteCode) { }
