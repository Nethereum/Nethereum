...
namespace Nethereum.ENS.TestRegistrar.Service
{

    public class TestRegistrarService
    {
    
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, TestRegistrarDeployment testRegistrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Web3 web3, TestRegistrarDeployment testRegistrarDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TestRegistrarDeployment>().SendRequestAsync(testRegistrarDeployment);
        }
        public static async Task<TestRegistrarService> DeployContractAndGetServiceAsync(Web3 web3, TestRegistrarDeployment testRegistrarDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public TestRegistrarService(Web3 web3, string contractAddress)
        {
            Web3 = web3;
