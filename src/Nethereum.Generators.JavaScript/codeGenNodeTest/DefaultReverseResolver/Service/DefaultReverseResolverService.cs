...
namespace Nethereum.ENS.DefaultReverseResolver.Service
{

    public class DefaultReverseResolverService
    {
    
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, DefaultReverseResolverDeployment defaultReverseResolverDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Web3 web3, DefaultReverseResolverDeployment defaultReverseResolverDeployment)
        {
        ...
        public static async Task<DefaultReverseResolverService> DeployContractAndGetServiceAsync(Web3 web3, DefaultReverseResolverDeployment defaultReverseResolverDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public DefaultReverseResolverService(Web3 web3, string contractAddress)
        {
            Web3 = web3;
