...
{
    /// <summary>
    /// Knobs for <see cref="DialScheduler"/>. Defaults mirror the canonical
    /// dialer constants — <c>maxActiveDialTasks</c>,
    /// <c>dialHistoryExpiration</c>, <c>trustedDialHistoryExpiration</c> — and
    /// a default <c>MaxPeers</c>.
    /// </summary>
    public sealed class DialSchedulerOptions
    {
        ...
        /// cap (the <c>MaxPeers</c> setting). At most
        /// <c>MaxPeers/2 + 1</c> connected peers may be the result of outbound
        /// dials we initiated. This is the eclipse-resistance hedge: an
