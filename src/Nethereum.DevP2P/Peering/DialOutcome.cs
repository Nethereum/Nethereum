namespace Nethereum.DevP2P.Peering
{
    ...
    /// scheduler treats them identically for suppression — geth's
    /// <c>dialscheduler.history.add</c> is called on every completed task
    /// regardless of whether the peer actually joined the pool.
    /// </summary>
