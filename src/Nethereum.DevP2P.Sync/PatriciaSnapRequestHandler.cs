...
namespace Nethereum.DevP2P.Sync
{
    ...
    /// - the <c>devp2p rlpx snap-test</c> conformance suite (5 sub-tests)
    ...
    public class PatriciaSnapRequestHandler : ISnapRequestHandler
    {
        ...
        /// regardless of the peer-supplied value. snap/1 interop invariant
        /// (<c>softResponseLimit = 2 * 1024 * 1024</c>).
        /// </summary>
        ...
        /// cannot be bounded by bytes alone. snap/1 interop invariant
        /// (<c>maxCodeLookups = 1024</c>).
        /// </summary>
        public const int MaxCodeLookups = 1024;

        /// <summary>
        /// Hard count cap on the total number of trie-node blobs returned per
        /// GetTrieNodes response, summed across all pathsets in the request.
        /// snap/1 interop invariant (<c>maxTrieNodeLookups = 1024</c>).
        /// </summary>
        public const int MaxTrieNodeLookups = 1024;

        /// <summary>
        /// Wall-clock cap on a single GetTrieNodes service call. snap/1 interop
        /// invariant (<c>maxTrieNodeTimeSpent = 5 seconds</c>).
        /// </summary>
        ...
        /// in-flight contract atomically. snap/1 interop invariant
        /// (<c>stateLookupSlack = 0.1</c>).
        /// </summary>
