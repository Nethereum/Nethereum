...
namespace Nethereum.DevP2P.Sync
{
    ...
    /// (the dominant account type), which is the slim encoding the snap/1 wire
    /// format and its budget arithmetic assume — without this, our 4000-byte
    /// AccountRange responses fit ~2.2x fewer accounts than peers expect.
    ///
