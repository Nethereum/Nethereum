...
namespace Nethereum.Uniswap.V2.UniswapV2Router02
{
    public partial class UniswapV2Router02Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3.Web3 web3, UniswapV2Router02Deployment uniswapV2Router02Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Web3.Web3 web3, UniswapV2Router02Deployment uniswapV2Router02Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<UniswapV2Router02Deployment>().SendRequestAsync(uniswapV2Router02Deployment);
        }

        public static async Task<UniswapV2Router02Service> DeployContractAndGetServiceAsync(Web3.Web3 web3, UniswapV2Router02Deployment uniswapV2Router02Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public UniswapV2Router02Service(Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
