...
using Nethereum.Uniswap.V2.UniswapV2ERC20.ContractDefinition;

namespace Nethereum.Uniswap.V2.UniswapV2ERC20
{
    public partial class UniswapV2ERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3.Web3 web3, UniswapV2ERC20Deployment uniswapV2ERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Web3.Web3 web3, UniswapV2ERC20Deployment uniswapV2ERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<UniswapV2ERC20Deployment>().SendRequestAsync(uniswapV2ERC20Deployment);
        }

        public static async Task<UniswapV2ERC20Service> DeployContractAndGetServiceAsync(Web3.Web3 web3, UniswapV2ERC20Deployment uniswapV2ERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public UniswapV2ERC20Service(Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
