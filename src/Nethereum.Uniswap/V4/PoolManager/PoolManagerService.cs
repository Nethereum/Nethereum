...
namespace Nethereum.Uniswap.V4.Contracts.PoolManager
{
    public partial class PoolManagerService
    {
        ...
        public async Task<List<V4PoolInfo>> GetAllPoolsAsync(
            BigInteger fromBlockNumber,
            BigInteger toBlockNumber,
            ...
            int retryWeight = BlockchainLogProcessingService.RetryWeight)
        {
            ...
            return events.Select(e => new V4PoolInfo
            {
                PoolId = e.Event.Id,
        ...
        public async Task<V4PoolInfo> FindPoolAsync(
            string currency0,
            string currency1,
            uint fee,
            int tickSpacing,
        ...
        public async Task<List<V4PoolInfo>> GetPoolsForPairAsync(
            string currency0,
            string currency1,
            BigInteger fromBlockNumber,
            BigInteger toBlockNumber,
