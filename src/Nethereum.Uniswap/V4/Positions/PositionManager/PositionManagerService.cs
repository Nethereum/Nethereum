...
namespace Nethereum.Uniswap.V4.PositionManager
{
    ...
    public partial class PositionManagerService
    {
            ...
            string stateViewAddress)
        {
            ...
            var decodedInfo = PositionInfoDecoder.Current.DecodePositionInfo(packedInfo);
            ...
            var unclaimedFees = FeeCalculator.Current.CalculateUnclaimedFees(
                liquidity,
            ...
            var isInRange = PositionInfoUtils.Current.IsPositionInRange(currentTick, decodedInfo.TickLower, decodedInfo.TickUpper);
