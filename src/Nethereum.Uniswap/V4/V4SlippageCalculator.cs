...
namespace Nethereum.Uniswap.V4
{
    ...
    public static class V4SlippageCalculator
    {
        ...
        public static MinimumLiquidityAmounts CalculateMinimumLiquidityAmounts(
            BigInteger amount0,
            BigInteger amount1,
            BigDecimal slippageTolerancePercentage)
        {
            ...
            return new MinimumLiquidityAmounts
            {
                MinAmount0 = result0.AmountWithSlippage,
                MinAmount1 = result1.AmountWithSlippage
            };
        }
