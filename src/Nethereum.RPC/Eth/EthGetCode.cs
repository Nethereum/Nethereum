    ...
    public class EthGetCode : RpcRequestResponseHandler<string>
        {
            ...
            public async Task<string> SendRequestAsync( string address, BlockParameter block, string id = Constants.DEFAULT_REQUEST_ID)
            {
            ...
            {
                return await base.SendRequestAsync( address, BlockParameter.CreateLatest(), id);
            }
