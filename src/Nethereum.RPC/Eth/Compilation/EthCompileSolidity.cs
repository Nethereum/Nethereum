...
namespace Nethereum.RPC.Eth.Compilation
{
    ...
    {
        public EthCompileSolidity(RpcClient client) : base(client, ApiMethods.eth_compileSolidity.ToString())
        {

        }

        public async Task<String> SendRequestAsync( string contractCode, string id = Constants.DEFAULT_REQUEST_ID)
        {
