...
namespace Nethereum.RPC.Eth.Transactions
{
    public interface IEthFeeHistory
    {
        ...
        /// <returns></returns>
        Task<FeeHistoryResult> SendRequestAsync(uint blockCount, BlockParameter highestBlockNumber, int[] rewardPercentiles = null, object id = null);
        ...
        /// Floating point value between 0 and 100.</param>
        /// <returns></returns>
        RpcRequest BuildRequest(uint blockCount, BlockParameter highestBlockNumber, int[] rewardPercentiles = null, object id = null);
    }
}