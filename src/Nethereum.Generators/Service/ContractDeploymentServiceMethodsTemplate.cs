...
{SpaceUtils.TwoTabs}}}";
            ...
            var sendRequestContract =
                $@"{SpaceUtils.TwoTabs}public async Task<{_serviceModel.GetTypeName()}> DeployContractAndGetServiceAsync(Web3 web3, {messageType} {messageVariableName}, CancellationTokenSource cancellationTokenSource = null)
{SpaceUtils.TwoTabs}{{
