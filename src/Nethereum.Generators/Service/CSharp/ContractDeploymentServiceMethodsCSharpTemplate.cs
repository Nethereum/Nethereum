    ...
    public class ContractDeploymentServiceMethodsCSharpTemplate
    {
        ...
        public string GenerateMethods()
        {
            ...
            var sendRequestReceipt =
                $@"{SpaceUtils.TwoTabs}public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3.Web3 web3, {messageType} {messageVariableName}, CancellationTokenSource cancellationTokenSource = null)
{SpaceUtils.TwoTabs}{{
...
{SpaceUtils.TwoTabs}}}";
            ...
            var sendRequest =
                $@"{SpaceUtils.TwoTabs}public static Task<string> DeployContractAsync(Web3.Web3 web3, {messageType} {messageVariableName})
{SpaceUtils.TwoTabs}{{
...
{SpaceUtils.TwoTabs}}}";
            ...
            var sendRequestContract =
                $@"{SpaceUtils.TwoTabs}public static async Task<{_serviceModel.GetTypeName()}> DeployContractAndGetServiceAsync(Web3.Web3 web3, {messageType} {messageVariableName}, CancellationTokenSource cancellationTokenSource = null)
{SpaceUtils.TwoTabs}{{
