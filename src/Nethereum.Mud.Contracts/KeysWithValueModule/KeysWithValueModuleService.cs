...
using Nethereum.Mud.Contracts.KeysWithValueModule.ContractDefinition;

namespace Nethereum.Mud.Contracts.KeysWithValueModule
{
    public partial class KeysWithValueModuleService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, KeysWithValueModuleDeployment keysWithValueModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, KeysWithValueModuleDeployment keysWithValueModuleDeployment)
        {
        ...
        public static async Task<KeysWithValueModuleService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, KeysWithValueModuleDeployment keysWithValueModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public KeysWithValueModuleService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
