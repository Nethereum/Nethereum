...
namespace Nethereum.Mud.Contracts.World.Systems.BalanceTransferSystem
{
    ...
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(IWeb3 web3, BalanceTransferSystemDeployment balanceTransferSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(IWeb3 web3, BalanceTransferSystemDeployment balanceTransferSystemDeployment)
        {
        ...
        public static async Task<BalanceTransferSystemService> DeployContractAndGetServiceAsync(IWeb3 web3, BalanceTransferSystemDeployment balanceTransferSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public BalanceTransferSystemService(IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
