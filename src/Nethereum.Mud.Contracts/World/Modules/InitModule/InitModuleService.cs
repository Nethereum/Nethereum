...
namespace Nethereum.Mud.Contracts.World.Modules.InitModule
{
    public partial class InitModuleService : ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(IWeb3 web3, InitModuleDeployment initModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(IWeb3 web3, InitModuleDeployment initModuleDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<InitModuleDeployment>().SendRequestAsync(initModuleDeployment);
        }

        public static async Task<InitModuleService> DeployContractAndGetServiceAsync(IWeb3 web3, InitModuleDeployment initModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public InitModuleService(IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
