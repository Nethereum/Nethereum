...
using Nethereum.Mud.Contracts.World.Modules.Unstable_DelegationWithSignatureModule.ContractDefinition;


namespace Nethereum.Mud.Contracts.World.Modules.Unstable_DelegationWithSignatureModule
{
    public partial class UnstableDelegationwithsignaturemoduleService : ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(IWeb3 web3, UnstableDelegationwithsignaturemoduleDeployment unstableDelegationwithsignaturemoduleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(IWeb3 web3, UnstableDelegationwithsignaturemoduleDeployment unstableDelegationwithsignaturemoduleDeployment)
        {
        ...
        public static async Task<UnstableDelegationwithsignaturemoduleService> DeployContractAndGetServiceAsync(IWeb3 web3, UnstableDelegationwithsignaturemoduleDeployment unstableDelegationwithsignaturemoduleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public UnstableDelegationwithsignaturemoduleService(IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
