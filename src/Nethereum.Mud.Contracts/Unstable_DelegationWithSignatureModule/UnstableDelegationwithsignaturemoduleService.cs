...
using Nethereum.Mud.Contracts.Unstable_DelegationWithSignatureModule.ContractDefinition;

namespace Nethereum.Mud.Contracts.Unstable_DelegationWithSignatureModule
{
    public partial class UnstableDelegationwithsignaturemoduleService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, UnstableDelegationwithsignaturemoduleDeployment unstableDelegationwithsignaturemoduleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<UnstableDelegationwithsignaturemoduleDeployment>().SendRequestAndWaitForReceiptAsync(unstableDelegationwithsignaturemoduleDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, UnstableDelegationwithsignaturemoduleDeployment unstableDelegationwithsignaturemoduleDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<UnstableDelegationwithsignaturemoduleDeployment>().SendRequestAsync(unstableDelegationwithsignaturemoduleDeployment);
        }

        public static async Task<UnstableDelegationwithsignaturemoduleService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, UnstableDelegationwithsignaturemoduleDeployment unstableDelegationwithsignaturemoduleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, unstableDelegationwithsignaturemoduleDeployment, cancellationTokenSource);
            return new UnstableDelegationwithsignaturemoduleService(web3, receipt.ContractAddress);
        }

        public UnstableDelegationwithsignaturemoduleService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
