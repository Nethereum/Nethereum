...
using Nethereum.Mud.Contracts.KeysInTableModule.ContractDefinition;

namespace Nethereum.Mud.Contracts.KeysInTableModule
{
    public partial class KeysInTableModuleService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, KeysInTableModuleDeployment keysInTableModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, KeysInTableModuleDeployment keysInTableModuleDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<KeysInTableModuleDeployment>().SendRequestAsync(keysInTableModuleDeployment);
        }

        public static async Task<KeysInTableModuleService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, KeysInTableModuleDeployment keysInTableModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public KeysInTableModuleService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
