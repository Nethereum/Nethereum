...
using Nethereum.Mud.Contracts.UniqueEntityModule.ContractDefinition;

namespace Nethereum.Mud.Contracts.UniqueEntityModule
{
    public partial class UniqueEntityModuleService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, UniqueEntityModuleDeployment uniqueEntityModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, UniqueEntityModuleDeployment uniqueEntityModuleDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<UniqueEntityModuleDeployment>().SendRequestAsync(uniqueEntityModuleDeployment);
        }

        public static async Task<UniqueEntityModuleService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, UniqueEntityModuleDeployment uniqueEntityModuleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public UniqueEntityModuleService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
