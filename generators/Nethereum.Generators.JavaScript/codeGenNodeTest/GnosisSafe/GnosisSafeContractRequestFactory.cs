...
{
    public partial class GnosisSafeContractRequestFactory 
    {
        ...
        public GnosisSafeContractRequestFactory(string contractAddress, IContractTransactionUnityRequestFactory contractTransactionUnityRequestFactory, IContractQueryUnityRequestFactory contractQueryUnityRequestFactory)
            {
        ...
        public DefaultAdminRoleQueryRequest CreateDefaultAdminRoleQueryRequest()
        {
            return new DefaultAdminRoleQueryRequest(ContractQueryUnityRequestFactory, ContractAddress);
        }


        public MinterRoleQueryRequest CreateMinterRoleQueryRequest()
        {
            return new MinterRoleQueryRequest(ContractQueryUnityRequestFactory, ContractAddress);
        }
        ...
        public GetRoleAdminQueryRequest CreateGetRoleAdminQueryRequest()
        {
            return new GetRoleAdminQueryRequest(ContractQueryUnityRequestFactory, ContractAddress);
        }


        public GetRoleMemberQueryRequest CreateGetRoleMemberQueryRequest()
        {
            return new GetRoleMemberQueryRequest(ContractQueryUnityRequestFactory, ContractAddress);
        }


        public GetRoleMemberCountQueryRequest CreateGetRoleMemberCountQueryRequest()
        {
            return new GetRoleMemberCountQueryRequest(ContractQueryUnityRequestFactory, ContractAddress);
        }


        public GrantRoleTransactionRequest CreateGrantRoleTransactionRequest()
        {
            return new GrantRoleTransactionRequest(ContractTransactionUnityRequestFactory, ContractAddress);
        }


        public HasRoleQueryRequest CreateHasRoleQueryRequest()
        {
            return new HasRoleQueryRequest(ContractQueryUnityRequestFactory, ContractAddress);
        }
        ...
        public RenounceRoleTransactionRequest CreateRenounceRoleTransactionRequest()
        {
            return new RenounceRoleTransactionRequest(ContractTransactionUnityRequestFactory, ContractAddress);
        }


        public RevokeRoleTransactionRequest CreateRevokeRoleTransactionRequest()
        {
            return new RevokeRoleTransactionRequest(ContractTransactionUnityRequestFactory, ContractAddress);
        }
